...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['pay_method'])) {
    ...
    $amount = $booking['total_amount']; // total booking

    $sql_payment = "INSERT INTO payments 
        (booking_id, amount, method, status, created_at) 
        VALUES 
        ($booking_id, $amount, '$pay_method', 'pending', NOW())";
        ...
        <main class="admin-main">
            ...
            <?php if ($active_tab == 'overview'): ?>
                ...
                <div class="card-panel">
                    ...
                    ";
                    $upcoming_list = mysqli_query($conn, $upcoming_list_query);

                    if ($upcoming_list && mysqli_num_rows($upcoming_list) > 0):
                        while ($b = mysqli_fetch_assoc($upcoming_list)):
